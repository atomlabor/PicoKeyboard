...
{
    (void)irqMask; // Verhindert ungenutzte Variablen-Warnung
    rtos_signalEvent(&sVBlankEvent);
}

static void mcuIrq(u32 irq2Mask)
{
    (void)irq2Mask; // Verhindert ungenutzte Variablen-Warnung
    sMcuIrqFlag = true;
}
...
{
    (void)arg; // Verhindert ungenutzte Variablen-Warnung
    while (true)
    {
        tud_task();
    }
